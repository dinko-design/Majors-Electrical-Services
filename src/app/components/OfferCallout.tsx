  ...
  return (
    <section className="relative w-full py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1765862835326-14b5070fdde9?crop=entropy&cs=tinysrgb&fit=max&fm=webp&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBob21lJTIwbGlnaHRpbmclMjBlbGVjdHJpY2FsfGVufDF8fHx8MTc3MDE4NjAzMXww&ixlib=rb-4.1.0&q=75&w=1200"
